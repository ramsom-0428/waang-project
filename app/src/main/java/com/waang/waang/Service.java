    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goToBlog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://waangsungshin.blogspot.com/2021/07/blog-post_6.html"));
        ...
        serviceContent.setText(
                "제 1 장 총칙\n" +
                        ...
                        "제 1 조 (목적)\n" +
                        "\n" +
                        "본 약관은 덤프잇이 운영하는 어플 (와앙_수정아 떠먹여줄게!) 의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.\n" +
                        "\n" +
                        "\n" +
                        "\n" +
                        "제 2 조 (용어의 정의)\n" +
